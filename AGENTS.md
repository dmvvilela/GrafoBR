...
- Data foundation: **verified real** (see `docs/DATA-FEASIBILITY.md`) — the 5 core br-acc
  extractors are production code, not stubs. New work = ego-scoping + DuckDB/JSON + bulk download.
